export const slickSlideSettings = {
  dots: true,
  infinite: false,
  speed: 500,
  slidesToShow: 5,
...
export const servicesList = [
  {
    heading: { sub: "Build your brand", main: "Logo Design" },
    pictureEle: (
      <picture>
        <source
  ...
  {
    heading: { sub: "Customize your site", main: "WordPress" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Share you message", main: "Voice Over" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Engage your audience", main: "Video Explainer" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Reach your customers", main: "Social Media" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Unlock growth online", main: "SEO" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Color your dreams", main: "Illustration" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Go global", main: "Translation" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Learn your business", main: "Data Entry" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
  ...
  {
    heading: { sub: "Showcase your story", main: "Book Covers" },
    pictureEle: (
      <picture>
        <source
          media="(min-width: 1060px)"
